...
function process(dataInfo, get_data){
  ...
  dataInfo['InValue'] += temp_inValue.slice(0, -1);
  dataInfo['OutValue'] += temp_outValue.slice(0, -1);

  temp_inValue = dataInfo['InValue'];
  temp_outValue = dataInfo['OutValue'];

  console.log("LABEL-01: ")
  console.log(temp_key)
  console.log("DATASET-01: ")
  console.log(dataInfo['InValue'])
  console.log("DATASET-01: ")
  console.log(dataInfo['OutValue'])
