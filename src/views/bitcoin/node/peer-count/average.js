...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/node/peer-count/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/node/peer-count/year"
];
var tag = "value";
                    ...
                    tbody={[
                      {
                        data: [
                          ...
                          { text: "비트코인 서버가 설치된 서버(노드)에서 트랜잭션 및 블록 데이터를 전파받은 현재 활동중인 노드들의 수" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "수집 방법" },
                          { text: "syslog에서 수집한 log 데이터를 참조" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "일간 평균 | 수집한 log들의 " },
                        ]
                      },
                    ]}
                  />
