...
let dataSource;
let url = "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/number-of-node/value/hour";
var tag = "value";
var title = "Total Nodes";
var caption = "Number of nodes in bitcoin networks.";

ReactFC.fcRoot(FusionCharts, charts, Zoomline, FusionTheme);
charts(FusionCharts);


class totalNodes extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "data1",
