...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/node/node-usage/memory-usage/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/node/node-usage/memory-usage/year"
];
var tag = "value";
