...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/node/node-usage/cached-size/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/node/node-usage/cached-size/year"
];
var tag = "value";
