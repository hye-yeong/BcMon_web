...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/node/bandwidth-usage/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/node/bandwidth-usage/year"
];
var tag = "value";
var title = "Bandwidth Usage";
var caption = "The average of nodes transaction rate per day";
                    ...
                    tbody={[
                      {
                        data: [
                          ...
                          { text: "conntime(피어와 연결된 시간), bytesrecv(받은 바이트 수), bytessend(보낸 바이트 수), lastrecv(마지막으로 데이터를 받은 시간) " },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "수집 방법" },
                          { text: "10초 간격으로 노드와 피어간의 데이터 전송속도를 측정" },
                        ]
                      },
                      {
                        data: [
