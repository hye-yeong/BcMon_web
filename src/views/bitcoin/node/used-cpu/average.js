...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/node/node-usage/cpu-usage/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/node/node-usage/cpu-usage/year"
];
var tag = "value";
var title = "CPU Usage";
