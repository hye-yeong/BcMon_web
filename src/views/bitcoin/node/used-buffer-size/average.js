...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/node/node-usage/buffer-size/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/node/node-usage/buffer-size/year"
];
var tag = "value";
