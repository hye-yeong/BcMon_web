...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-utxo/total/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-utxo/total/year"
];
var tag = "value";
var title = "Total";
var caption = "The total number of UTXOs (Unspent Transaction Outputs) per day.";

class utxoCount extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "하루 동안 분석된 블록들의 상세정보에서 [vin], [vout]필드를 참조하여 vout 값(value)과 vin 값(value)을 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "하루 동안 발생한 블록의 vout 값(value) - 하루 동안 발생한 블록의  vin 값(value)" },
                        ]
                      },
                    ]}
                  />
