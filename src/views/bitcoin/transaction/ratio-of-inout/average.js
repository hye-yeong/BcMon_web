...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-transaction/ratio-of-input-to-output/value/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-transaction/ratio-of-input-to-output/value/year"
]
var tag = "value";
var title = "Ratio of input to ouput";
var caption = "The average ratio of number of transaction inputs to number of transaction outputs per day.";

class averageRatioofInout extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
            ...
            <Col xm="12" md={{ size: 10, offset: 1 }}>
              <Card>
                ...
                <CardBody>
                    ...
                    tbody={[
                      {
                        data: [
                          ...
                          { text: "각 트랜잭션의 vin, vout" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "수집 방법" },
                          { text: "하루 동안 생성된 블록 내 트랜젝션을 포함한 모든 트랜잭션의 [vin], [vout]필드 개수를 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "하루 동안 발생한 모든 블록 내 트랜잭션의 vout, vin 비율 | (하루동안 발생한 트랜잭션 vout 총합) / (하루동안 발생한 트랜잭션 vin 총합)" },
                        ]
                      },
                    ]}
                  />
                  ...
                  <ul>
                    <li>vin: 트랜잭션에서 송신자의 수</li>
                  </ul>
                  <ul>
                    <li>vout: 트랜잭션에서 수신자의 수</li>
                  </ul>
                </CardBody>
              </Card>
            </Col>            
...
export default averageRatioofInout;
