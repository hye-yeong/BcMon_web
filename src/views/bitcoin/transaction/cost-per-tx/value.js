...
let dataSource=[];
let url = [
    "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-transaction/rate-of-mining-revenue/value/day",
    "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-transaction/rate-of-mining-revenue/value/year"
];
var tag = "value";
var title = "Ratio of mining revenue";
var caption = "The daily average ratio of mining revenue (excluding fee) to number of transaction";
            ...
            <Col xm="12" md={{ size: 10, offset: 1 }}>
              <Card>
                ...
                <CardBody>
                    ...
                    tbody={[
                      {
                        data: [
                          ...
                          { text: "각 블록의 코인베이스 트랜잭션을 포함한 number of transaction(nTx)" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "수집 방법" },
                          { text: "당일까지 분석된 블록들의 상세정보에서 [nTx]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "하루 동안 발생한 모든 트랜잭션 총합의 비율 | (당일 발생했던 코인베이스 트랜잭션 총합 / 트랜잭션 총합)" },
                        ]
                      },
                    ]}
                  />
                  ...
                  <ul>
                    <li>코인베이스 트랜잭션(Coinbase Transaction): 블록을 생성한 채굴자(miner)에게 보상으로 코인을 송금한 트랜잭션</li>
                  </ul>                  
                </CardBody>
              </Card>
            </Col>            
