...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/transaction-volume/rate-of-mining-revenue/value/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/transaction-volume/rate-of-mining-revenue/value/year"
];
var tag = "value";
var title = "Ratio of mining revenue to transaction volume";
var caption = "The daily average ratio of mining revenue (excluding fee) to total transaction volumes";

class costOfTxVolume extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      {
                        data: [
                          ...
                          { text: "각 트랜잭션(코인베이스 트랜잭션 포함)의 vout" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "수집 방법" },
                          { text: "하루 동안 생성된 블록 내 모든 트랜잭션의 [vout]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "하루 동안 발생한 모든 블록 내 트랜잭션의 vout 비율 | (당일 발생했던 코인베이스 총합 / 트랜잭션 출력 값 총합)" },
                        ]
                      },
                    ]}
                  />
