...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-vin/total/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-vin/total/year"
];
var tag = "value";
var title = "Total";
var caption = "The total number of transaction inputs per day";

ReactFC.fcRoot(FusionCharts, charts, Zoomline, FusionTheme);
charts(FusionCharts);


class totalNumberofvin extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "하루 동안 발생한 모든 블록 내 vin의 총합" },
                        ]
                      },
                    ]}
                  />
...
export default totalNumberofvin;
