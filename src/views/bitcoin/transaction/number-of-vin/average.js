...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-vin/average/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-vin/average/year"
];
var tag = "value";
var title = "Average";
var caption = "The average number of transaction inputs per day";

class averageNumberofvin extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "하루 동안 발생한 블록 내 트랜잭션의 [vin]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "일일 평균 | (하루동안 발생한 트랜잭션의 vin 개수 총합) / (하루 생성된 블록 개수)" },
                        ]
                      },
                    ]}
                  />
...
export default averageNumberofvin;
