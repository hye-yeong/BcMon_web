...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-transaction/total/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-transaction/total/year"
];
var tag = "value";
var title = "Total";
var caption = "The total number of transactions per day";

class sumOfTx extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "일일 총합 | 하루동안 발생한 모든 블록 nTx 총합" },
                        ]
                      },
                    ]}
                  />
