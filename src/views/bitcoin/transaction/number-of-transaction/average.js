...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-transaction/average/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-transaction/average/year"
];
var tag = "value";
var title = "Average";
...
class averageOfTx extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "일일 평균 | (하루동안 발생한 모든 블록들의 nTx 총합) / (하루 생성된 블록 개수)" },
                        ]
                      },
                    ]}
                  />
