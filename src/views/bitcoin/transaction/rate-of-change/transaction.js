...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-transaction/rate-of-change/value/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-transaction/rate-of-change/value/year"
]
var tag = "value";
var title = "Rate of change";
var caption = "The average rate of change to number of transactions per day.";

class rateOfChangeTransaction extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "이틀(당일, 전일) 간 발생한 블록들의 상세정보에서 [nTx]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "이틀동안 발생한 블록 nTx의 비율 | (당일 발생한 블록 nTx의 총합 / 전일 발생한 블록  nTx의 총합)" },
                        ]
                      },
                    ]}
                  />
...
export default rateOfChangeTransaction;
