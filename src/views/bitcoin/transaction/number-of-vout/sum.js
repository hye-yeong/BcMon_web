...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-vout/total/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/number-of-vout/total/year"
];
var tag = "value";
var title = "Total";
var caption = "The total number of transaction outputs per day";

class totalNumberofVout extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "하루 동안 발생한 모든 블록 내 vout의 총합" },
                        ]
                      },
                    ]}
                  />
...
export default totalNumberofVout;
