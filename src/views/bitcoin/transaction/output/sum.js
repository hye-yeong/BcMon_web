...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/vout-value/total/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/vout-value/total/year"
];
var tag = "value";
var title = "Total";
var caption = "The total transaction outputs value per day";
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "블록들의 상세정보에서 트랜잭션의 [vout]필드를 참조하여 vout 값(value)을 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "하루 동안 발생한 모든 블록 내 vout 값(value)의 총합" },
                        ]
                      },
                    ]}
                  />
