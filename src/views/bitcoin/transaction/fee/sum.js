...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/fee/total/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/transaction/fee/total/year"
];
var tag = "value";
var title = "Fee";
var caption = "The total transaction fee per day.";

class totalFee extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "하루 동안 발생한 블록들의 트랜잭션 상세정보에서 [fee]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
