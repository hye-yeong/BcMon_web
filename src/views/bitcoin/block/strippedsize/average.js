...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/stripped-block-size/average/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/stripped-block-size/average/year"
];
var tag = "avg_strippedsize_per_day";
var title = "Average";
var caption = "The average stripped block size per day";

ReactFC.fcRoot(FusionCharts, charts, Zoomline, FusionTheme);
charts(FusionCharts);

class averageStrippedsize extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "일일 평균 | (하루 동안 생성된 모든 블록의 strippedsize 총 합)/(하루 동안 생성된 블록의 수)" },
                        ]
                      },
                    ]}
                  />
...
export default averageStrippedsize;
