...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/block-weight/total/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/block-weight/total/year"
];
var tag = "sum_weight_per_day";
var title = "Total";
var caption = "The total block weight per day.";

ReactFC.fcRoot(FusionCharts, charts, Zoomline, FusionTheme);
charts(FusionCharts);

class sumWeight extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "하루 동안 생성된 모든 블록 weight의 총합" },
                        ]
                      },
                    ]}
                  />
