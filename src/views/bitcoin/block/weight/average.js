...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/block-weight/average/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/block-weight/average/year"
];
var tag = "avg_weight_per_day";
var title = "Average";
var caption = "The average of block weight per day";

ReactFC.fcRoot(FusionCharts, charts, Zoomline, FusionTheme);
charts(FusionCharts);

class averageWeight extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "하루 동안 생성된 블록들의 상세정보에서 [weight]필드를 참조하여 각 블록의 weight를 수집 " },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "일일 평균 | (하루 동안 생성된 모든 블록 weight의 총 합)/(하루 동안 생성된 블록의 수)" },
                        ]
                      },
                    ]}
                  />
