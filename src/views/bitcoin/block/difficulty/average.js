...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/difficulty/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/difficulty/year"
];
var tag = "value";
var title = "Difficulty";
var caption = "The average value of difficulty per day";
            ...
            <Col xm="12" md={{ size: 10, offset: 1 }}>
              <Card>
                ...
                <CardBody>
                  ...
                  />
                  <ul>
                    <li>Difficulty(블록생성 난이도): 채굴자(miner)는 블록 해시값이 Bits에서 제시하는 값 이하가 되는 nonce값을 찾음. Difficulty는 nonce값 계산의 어려운 정도로 나타냄</li>
                  </ul>
                </CardBody>
              </Card>
            </Col>            
