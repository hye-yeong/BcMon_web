...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/whole-revenue/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/whole-revenue/year"
];
var tag = "value";
var title = "whole Revenue";
var caption = "The total mining revenue (including Tx fee) per day";
            ...
            <Col xm="12" md={{ size: 10, offset: 1 }}>
              <Card>
                ...
                <CardBody>
                    ...
                    tbody={[
                      {
                        data: [
                          ...
                          { text: "각 블록의 fee (coinbase 포함)" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "수집 방법" },
                          { text: "블록들의 트랜잭션 상세정보에서 [fee]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "하루 동안 발생한 블록내의 트랜잭션 fee의 총합" },
                        ]
                      },
                    ]}
                  />
                  ...
                  <ul>
                    <li>fee(수수료): 채굴자(miner)가 새로운 블록을 생성하면, 블록에 포함된 모든 트랜잭션들은 채굴자(miner)에게 fee(수수료)를 지급함<br /></li>
                  </ul>  
                </CardBody>
              </Card>
            </Col>
