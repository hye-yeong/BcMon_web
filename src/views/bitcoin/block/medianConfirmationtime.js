...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/mining-interval/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/mining-interval/year"
];
var tag = "value";
var title = "Mining interval";
var caption = "The daily average time to mine a block";

class medianconfirmationtime extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "하루 동안 발생한 블록의 상세정보에서 [time]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "일일 평균 | (하루 동안 발생한 블록 time 총합 / 하루 동안 발생한 블록의 개수) " },
                        ]
                      },
                    ]}
                  />
                  <ul>
                    <li>confirmation: 해당 블록 위에 쌓인 블록의 개수, 제일 마지막에 쌓인 블록의 confirmations의 값은 1</li>
                  </ul>
                  <ul>
                    <li>mediantime: 현재 블록 이전에 생성된 11개의 BLock 생성 시간의 평균값으로, 현재 블록의 예상 생성 시간 값</li>
                  </ul>
                </CardBody>
              </Card>
            </Col>            
...
export default medianconfirmationtime;
