...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/block-size/rate-of-change/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/block-size/rate-of-change/year"
];
var tag = "value";
var title = "Rate of change";
var caption = "The average rate of block size change per day";

ReactFC.fcRoot(FusionCharts, charts, Zoomline, FusionTheme);
charts(FusionCharts);

class rateOfChangeSize extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "이틀(당일, 전일) 간 발생한 블록의 상세정보에서 [size]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "이틀동안 발생한 블록 size의 비율 | (당일 발생한 블록들의 size의 총합 / 전일 발생한 블록들의 size의 총합)" },
                        ]
                      },
                    ]}
                  />
...
export default rateOfChangeSize;
