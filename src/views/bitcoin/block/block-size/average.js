...
let dataSource=[];
let url = [
"http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/block-size/average/day",
"http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/block-size/average/year"
]
var tag = "value";
var title = "Average";
var caption = "The average block size per day";

ReactFC.fcRoot(FusionCharts, charts, Zoomline, FusionTheme);
charts(FusionCharts);

class blockSize_average extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
...
export default blockSize_average;
