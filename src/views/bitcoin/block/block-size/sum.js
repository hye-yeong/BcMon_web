...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/block-size/total/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/block-size/total/year"
];
var tag = "value";
var title = "Total";
var caption = "The total block size per day";

class blockSize_sum extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "하루 동안 발생한 블록의 상세정보에서 [size]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "일일 총합 | 하루동안 발생한 블록 size의 총합" },
                        ]
                      },
                    ]}
                  />
