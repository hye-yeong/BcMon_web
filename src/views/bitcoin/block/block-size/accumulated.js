...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/block-size/cumulative/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/block-size/cumulative/year"
];
var tag = "value";
var title = "Cumulative";
var caption = "The cumulative value of block size per day";

class blockSize_total extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
...
export default blockSize_total;
