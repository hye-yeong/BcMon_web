...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/block-size/insufficeint/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/block/block-size/insufficeint/year"
];
var tag = "abnor_size_count";
var title = "Insufficeint";
var caption = "Total number of blocks generated per day with size less than 500K";

ReactFC.fcRoot(FusionCharts, charts, Zoomline, FusionTheme);
charts(FusionCharts);

class insufficientSize extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "하루 동안 생성된 블록들의 상세정보에서 [size]필드를 참조하여 각 블록의 size를 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "하루 동안 생성된 블록들 중 size가 500K 이하인 블록의 수" },
                        ]
                      },
                    ]}
                  />
...
export default insufficientSize;
