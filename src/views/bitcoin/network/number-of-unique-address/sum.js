...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/network/number-of-unique-addresses/total/day",
  "http://bcmon.kmu.ac.kr/coin-data/bitcoin/graphs/network/number-of-unique-addresses/total/year"
];
var tag = "value";
var title = "Total";
var caption = "The total number of unique addresses per day. Unique address is a newly added address that is not in previous blocks.";

class uniqueAddress_sum extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "하루 동안 발생한 블록들에 저장된 트랜잭션에 기록된 addressses 정보를 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "하루 동안 발생한 블록 내 트랜잭션에 기록된 고유주소 개수의 총합 (단, 주소가 데이터베이스에 입력되기 전 전처리 과정에서 중복 제거)" },
                        ]
                      },
                    ]}
                  />
...
export default uniqueAddress_sum;
