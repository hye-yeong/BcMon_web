...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/node/node-usage/buffer-size/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/node/node-usage/buffer-size/year"
];
var tag = "value";
var title = "Buffer Size";
var caption = "The average used buffer size per day.";
                    ...
                    tbody={[
                      {
                        data: [
                          ...
                          { text: "Buffer Memory size" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "수집 방법" },
                          { text: "노드가 설치된 서버의 Buffer Memory size를 10초간격으로 측정하고 수집" },
                        ]
                      },
                      {
                        data: [
