...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/node/node-usage/cached-size/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/node/node-usage/cached-size/year"
];
var tag = "value";
var title = "Cached Size ";
var caption = "The average used cache size per day.";

class cachedSize extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      {
                        data: [
                          ...
                          { text: "Chached Memory size" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "수집 방법" },
                          { text: "노드가 설치된 서버의 Cache memory size를 10초 간격으로 측정하고 수집" },
                        ]
                      },
                      {
                        data: [
