...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/node/node-usage/memory-usage/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/node/node-usage/memory-usage/year"
];
var tag = "value";
var title = "Memory Usage";
var caption = "The average used memory per day.";

class used_memory extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "노드가 설치된 서버의 Memory 사용량을 10초 간격으로 측정하고 수집" },
                        ]
                      },
                      {
                        data: [
