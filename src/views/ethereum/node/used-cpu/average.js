...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/node/node-usage/cpu-usage/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/node/node-usage/cpu-usage/year"
];
var tag = "value";
var title = "CPU Usage";
var caption = "The average used CPU per day.";

class used_CPU extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "노드가 설치된 서버의 CPU 사용량을 10초 간격으로 측정하고 수집" },
                        ]
                      },
                      {
                        data: [
