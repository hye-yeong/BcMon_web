...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/network/difficulty/total/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/network/difficulty/total/year"
];
var tag = "value";
var title = "Total of difficulty";
var caption = "The total of difficulty per day";

class difficulty_sum extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "일일 총합 | 하루동안 발생한 블록 difficulty 총합" },
                        ]
                      },
                    ]}
                  />
