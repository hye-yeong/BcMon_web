...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/network/difficulty/average/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/network/difficulty/average/year"
];
var tag = "value";
var title = "Average of difficulty";
var caption = "The average of difficulty per day";

class difficulty_avg extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      {
                        data: [
                          ...
                          { text: "각 블록 difficulty" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "수집 방법" },
                          { text: "하루 동안 발생한 블록의 상세정보에서 [difficulty]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "일일 평균 | (하루동안 발생한 블록 difficulty 총합 / 하루 동안 발생한 블록의 개수)" },
                        ]
                      },
                    ]}
                  />
