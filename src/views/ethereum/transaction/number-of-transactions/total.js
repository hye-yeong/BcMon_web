...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/transaction/number-of-transaction/cumulative/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/transaction/number-of-transaction/cumulative/year"
];
var tag = "value";
  var title = "Cumulative";
var caption = "The accumulated value of number of transactions per day";

class numberOfTx_total extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "하루동안 발생한 블록들의 상세정보에서 [nTx]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "당일까지 분석된 모든 블록들의 nTx 총합" },
                        ]
                      },
                    ]}
                  />
...
export default numberOfTx_total;
