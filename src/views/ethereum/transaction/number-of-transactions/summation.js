...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/transaction/number-of-transaction/total/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/transaction/number-of-transaction/total/year"
];
var tag = "value";
var title = "Total";
var caption = "The total of number of transactions per day";

class numberOfTx_sum extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
