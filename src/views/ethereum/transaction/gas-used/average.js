...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/transaction/gas-used/average/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/transaction/gas-used/average/year"
];
var tag = "value";
var title = "Average";
var caption = "The average of gasUsed per day";

class gasUsed_avg extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "일일 평균 | (하루 동안 발생한 모든 블록들의 gasUsed 총합 / 하루동안 생성된 블록 개수)" },
                        ]
                      },
                    ]}
                  />
