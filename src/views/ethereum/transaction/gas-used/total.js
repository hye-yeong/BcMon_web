...
let dataSource=[];
let url = [
    "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/transaction/gas-used/cumulative/day",
    "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/transaction/gas-used/cumulative/year"
];
var tag = "value";
var title = "cumulative";
var caption = "The accumulated value of gasUsed per day";

class gasUsed extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "당일까지 분석된 블록들의 상세정보에서 [gasUsed]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "당일까지 분석된 모든 블록들의 gasUsed 총합" },
                        ]
                      },
                    ]}
                  />
