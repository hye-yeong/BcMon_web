...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/smartcontract/calling/cumulative/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/smartcontract/calling/cumulative/year"
];
var tag = "value";
var title = "Cumulative";
var caption = "Number of Transaction Calling Smart Contracts";

class smartcontract_calling_cumulative extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
...
export default smartcontract_calling_cumulative;
