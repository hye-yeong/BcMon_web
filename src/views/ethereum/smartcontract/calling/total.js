...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/smartcontract/calling/total/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/smartcontract/calling/total/year"
];
var tag = "value";
var title = "Total";
var caption = "Number of Transaction Calling Smart Contracts";

class smartcontract_calling_total extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
...
export default smartcontract_calling_total;
