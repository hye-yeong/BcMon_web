...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/smartcontract/creation/total/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/smartcontract/creation/total/year"
];
var tag = "value";
var title = "Total";
var caption = "Number of Smart Contract Creation";

class smartcontract_total extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
...
export default smartcontract_total;
