...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/smartcontract/creation/cumulative/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/smartcontract/creation/cumulative/year"
];
var tag = "value";
var title = "Cumulative";
var caption = "Number of Smart Contract Creation";

class smartcontract_cumulative extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
...
export default smartcontract_cumulative;
