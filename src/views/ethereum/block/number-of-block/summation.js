...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/block/number-of-blocks/total/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/block/number-of-blocks/total/year"
];
var tag = "value";
var title = "Total";
var caption = "The total of number of blocks per day";

class numberOfBlock_sum extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
...
export default numberOfBlock_sum;
