...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/block/number-of-blocks/cumulative/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/block/number-of-blocks/cumulative/year"
];
var tag = "value";
var title = "Cumulative";
var caption = "The accumulated value of number of blocks per day";

class numberOfBlock_total extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
...
export default numberOfBlock_total;
