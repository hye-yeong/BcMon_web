...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/block/block-size/average/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/block/block-size/average/year"
];
var tag = "value";
var title = "Average";
var caption = "The average of size of blocks per day";

class sizeOfBlock_avg extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "하루동안 발생한 블록의 상세정보에서 [size]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "일일 평균 | (하루동안 발생한 블록 size의 총합 / 하루 동안 발생한 블록의 개수)" },
                        ]
                      },
                    ]}
                  />
...
export default sizeOfBlock_avg;
