...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/block/block-size/cumulative/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/block/block-size/cumulative/year"
];
var tag = "value";
var title = "Cumulative";
var caption = "The accumulated value of size of blocks per day";

class sizeOfBlock_total extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "당일까지 분석된 블록의 상세정보에서 [size]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "당일까지 분석된 블록 size 총합" },
                        ]
                      },
                    ]}
                  />
...
export default sizeOfBlock_total;
