...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/block/number-of-uncles/average/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/block/number-of-uncles/average/year"
];
var tag = "value";
var title = "Average";
var caption = "The average number of uncles per day";

class numberOfUncles_avg extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "하루동안 발생한 블록의 상세정보에서 [uncle]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "일일 평균 | (하루동안 발생한 블록의 uncle 개수의 총합 / 하루동안 발생한 블록의 개수)" },
                        ]
                      },
                    ]}
                  />
...
export default numberOfUncles_avg;
