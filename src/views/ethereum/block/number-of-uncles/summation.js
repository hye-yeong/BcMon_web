...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/block/number-of-uncles/total/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/block/number-of-uncles/total/year"
];
var tag = "value";
var title = "Total";
var caption = "The total of number of uncles per day";

class numberOfUncles_sum extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "일일 총합 | 하루동안 발생한 블록의 uncle 개수의 총합" },
                        ]
                      },
                    ]}
                  />
...
export default numberOfUncles_sum;
