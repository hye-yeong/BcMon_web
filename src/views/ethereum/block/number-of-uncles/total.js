...
let dataSource=[];
let url = [
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/block/number-of-uncles/cumulative/day",
  "http://bcmon.kmu.ac.kr/coin-data/ethereum/graphs/block/number-of-uncles/cumulative/year"
];
var tag = "value";
var title = "Cumulative";
var caption = "The accumulated value of number of uncles per day";

class numberOfUncles_total extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "0"
                    ...
                    tbody={[
                      ...
                      },
                      {
                        data: [
                          ...
                          { text: "당일까지 분석된 블록의 상세정보에서 [uncle]필드를 참조하여 수집" },
                        ]
                      },
                      {
                        data: [
                          { className: "text-center", text: "분석 방법" },
                          { text: "당일까지 분석된 블록의 uncle 개수의 총합" },
                        ]
                      },
                    ]}
                  />
...
export default numberOfUncles_total;
