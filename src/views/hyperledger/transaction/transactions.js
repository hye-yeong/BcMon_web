...
let dataSource;
let url = "http://bcmon.kmu.ac.kr/hyperledger/graphs/transaction/transaction/year";
var tag = "value";
var title = "transaction";
var caption = "Total transaction per day";

class hyperledger_transaction extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "data1",
      //mean은 그래프 당 의미가 하나 밖에 없을 때는 사용하지 말것.
      mean:"Total Transaction"
    };
  }
  // 버튼 사용시 사용하는 생성자
...
export default hyperledger_transaction;
