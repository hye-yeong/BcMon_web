...
let dataSource;
let url = "http://bcmon.kmu.ac.kr/hyperledger/graphs/block/total-block/year";
var tag = "value";
var title = "Total block";
var caption = "Total block";

ReactFC.fcRoot(FusionCharts, charts, Zoomline, FusionTheme);
charts(FusionCharts);

class total_hyperBlock extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bigChartData: "data1",
...
export default total_hyperBlock;
